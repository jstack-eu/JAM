...
export default function Conditions({ pages, info }) {
    ...
    <div>
      <Layout pages={pages} info={info} inversedHeader>
        <div className="container">
          ...
          <p>Welcome to https://www.dvhydraulics.be/!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of DVHydraulics's Website, located at
            https://www.dvhydraulics.be/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use https://www.dvhydraulics.be/ if
          ...
          <p>
            ...
            https://www.dvhydraulics.be/, you agreed to use cookies in agreement
            with the DVHydraulics's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, DVHydraulics and/or its licensors own the
            intellectual property rights for all material on
            https://www.dvhydraulics.be/. All intellectual property rights are
            reserved. You may access this from https://www.dvhydraulics.be/ for
          ...
          <p>You must not:</p>
          <ul>
            <li>Republish material from https://www.dvhydraulics.be/</li>
            <li>
            ...
            <li>Redistribute content from https://www.dvhydraulics.be/</li>
          </ul>
          ...
          <p>
            ...
            DVHydraulics does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of DVHydraulics,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            DVHydraulics shall not be liable for the Comments or for any
          ...
          <p>
            DVHydraulics reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant DVHydraulics a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of DVHydraulics;
          ...
          <p>
            ...
            sending an e-mail to DVHydraulics. Please include your name, your
          ...
          <p>
            No use of DVHydraulics's logo or other artwork will be allowed for
